...
For this repo the naming word convention is something like `<one word description>_<location abbriviation>_<ride name>.flac` so that trivia about the sound effect is embeded in the file name.
This is not a hard requirement, especially if the samples come from unknown sources.

CSS1.DAT index | RCTC file name                      | Notes | Done? |
-------------- | --------------                      | ----- | ----- |
0              | CLIMB4                              |     
1              | TRACKS1                             |
2              | TRACKS3                             |
...
New Audio
Index number | OpenRCT2 File Name        | Notes
------------ | ------------------------- | -----
64           | hybrid_rc_lift_wh_untamed | Hybrid/Single Rail lifthill
65           | hybrid_rc_roar_wh_untamed | Hybrid/Single Rail friction
65           | log_flume_lift_pl_dino    | Water ride lifthill
